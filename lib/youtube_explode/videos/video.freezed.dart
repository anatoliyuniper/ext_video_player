...
//ignore: avoid_positional_boolean_parameters
  ...
  @override
  String toString() {
    return 'Video._internal(id: $id, title: $title, author: $author, uploadDate: $uploadDate, publishDate: $publishDate, description: $description, duration: $duration, keywords: $keywords, isLive: $isLive, watchPage: $watchPage)';
  }
